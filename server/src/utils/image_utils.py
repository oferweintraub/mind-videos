...
def save_thumbnail(
    ...
    *,
    ...
    """Create a thumbnail from an image file and save it to disk.

    Args:
        image_path: Source image path.
        output_path: Destination thumbnail path.
    ...
    thumbnail_bytes = resize_image(image_bytes, max_size=max_size, quality=quality)
    output_path.write_bytes(thumbnail_bytes)
    logger.info(f"Saved thumbnail {output_path} from {image_path}")
    return output_path
