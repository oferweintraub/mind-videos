...
from src.utils.image_utils import save_thumbnail
...
async def main_async(args):
    ...
    for i, style in plan_for_results:
        image_path = out_dir / f"option_{i}.png"
        thumb_path = out_dir / f"option_{i}_thumb.jpg"
